...
Help me update Alex agent files, commands, or CLAUDE.md. Tell me what you want to change.

---

## Alex Update — Agent File Maintenance
...
| `.claude/plugins/family-bridges-it/` | Plugin metadata or skills |
